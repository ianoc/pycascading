...
"""Meta operators make it easier to chain groups of operations seperated into logical groups"""
...
@composable
def split_and_count(parent):
    return parent | split_words | group_by('word', native.count())
